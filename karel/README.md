...
2. Ersetze den Inhalt der Datei: ```karel/karel.txt``` mit deinem neuesten Code.

3. Um dort weiterzumachen, wo du aufgehört hast, füge den Code aus: ```karel/karel.txt``` wieder in: ```%USERPROFILE%/karel/karel.txt```
